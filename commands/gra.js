...
// Funkcja formatująca liczby (np. 1000 -> 1.0k)
const formatNum = (n) => {
    let num = Number(n);
...
module.exports = {
    ...
    async handleInteraction(interaction) {
        ...
        // Inicjalizacja gracza, jeśli nie istnieje
        if (!data) {
        ...
        if (interaction.customId.startsWith('buy_')) {
            ...
            return interaction.reply({ content: "✅ Zakupiono!", flags: [MessageFlags.Ephemeral] });
        }
        ...
        if (interaction.customId === 'firework_boom') {
            ...
            return interaction.reply({ content: "🎆 **BUM!** Mnożnik wzrósł x2!", flags: [MessageFlags.Ephemeral] });
        }
